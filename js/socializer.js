...
(function(){
    ...
    _socializer.prototype = {
        ...
        sites:{
            ...
            fbmessenger: [ 'Facebook messenger', 'chat', 'fb-messenger://share?link={url}', '#2998ff', '' ],
            ...
            linkedin: [ 'LinkedIn', 'linkedin', 'http://www.linkedin.com/shareArticle?mini=true&amp;url={url}&amp;title={title}&amp;summary={excerpt}', '#0274B3', '' ],
            ...
            yahoobookmarks: [ 'Yahoo! Bookmarks', 'yahoo', 'https://bookmarks.yahoo.com/toolbar/savebm?u={url}&amp;t={title}&opener=bm&amp;ei=UTF-8&amp;d={excerpt}', '#4A00A1', '' ],
            youtube: [ 'Youtube', 'youtube', 'https://youtube.com/', '#cc181e', '' ],
